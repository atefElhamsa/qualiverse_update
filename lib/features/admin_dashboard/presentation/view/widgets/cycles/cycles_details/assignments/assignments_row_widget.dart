...
class AssignmentsRowWidget extends StatelessWidget {
  ...
  Widget _buildActionItem(
    ...
    return Expanded(
      ...
      child: Padding(
        padding: EdgeInsets.symmetric(horizontal: 8.w),
        child: BlocBuilder<ApproveRejectAssignmentCubit, ApproveRejectAssignmentState>(
          builder: (context, state) {
            if (state is ApproveRejectAssignmentLoading && state.indicatorId == assignment.id) {
              return Center(
                child: SizedBox(
                  height: 20.h,
                  width: 20.w,
              ...
              return Row(
                ...
                children: [
                  Tooltip(
                    ...
                    child: InkWell(
                      onTap: () => context.read<ApproveRejectAssignmentCubit>().approveAssignment(assignment.indicatorId),
                      ...
                      child: Container(
                        ...
                        child: Icon(Icons.check_rounded, color: AppColors.green, size: 20.sp),
                      ),
                    ),
                  ),
                  SizedBox(width: 8.w),
                  Tooltip(
                    ...
                    child: InkWell(
                      onTap: () => context.read<ApproveRejectAssignmentCubit>().rejectAssignment(assignment.indicatorId),
                      borderRadius: BorderRadius.circular(8.r),
                      child: Container(
                        padding: EdgeInsets.all(4.w),
                        decoration: BoxDecoration(
                        ...
                        child: Icon(Icons.close_rounded, color: AppColors.red, size: 20.sp),
                      ),
                    ),
                  ),
                ],
            ...
            return const Center(child: Text('-', style: TextStyle(color: AppColors.mainGrey)));
          },
        ),
      ),
    );
